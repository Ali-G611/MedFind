<x-master>
    @if ($a_user->isAdmin())
    <div>
        <form method="POST" action="{{ route('user.update', $user) }}" id="update"
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="input4" name="name" value='{{ $user->name }}'
            ...
            <div style="display:flex;justify-content:left;">
                ...
                <div style="margin-right: 5rem">
                    <a style="font-size: larger" href="{{ route('user.destroy', $user) }}"
        ...
        @if ($user->customer)
            <form action="{{ route('customer.update', $user->customer) }}" method="POST"
                style="width: 90%; margin-left:auto;margin-right:auto;margin-bottom: 2.5rem;margin-top: 2.5rem"
                class="row g-3">
                @csrf
                @method('PUT')
                ...
                <div class="col-md-6">
                    ...
                    <input style="font-size: medium" type="text" class="form-control" name="first_name"
                        id="input4" value="{{ $user->customer->first_name }}">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <input style="font-size: medium" type="text" class="form-control" id="inputAddress"
                        placeholder="1234 Main St" name="location" value="{{ $user->customer->location }}">
                </div>
                <div class="col-6">
                    <label for="input2" class="form-label">Phone</label>
                    <input style="font-size: medium" type="text" class="form-control" id="input2"
                        placeholder="+963---------" name="phone" value="{{ $user->customer->phone }}">
                </div>
                <div class="col-md-6">
                    ...
                    <input disabled style="font-size: medium" type="text" class="form-control" id="inputBalance"
                        value="{{ $user->customer->balance == null ? 0 : $user->customer->balance }}">
                </div>
                <div class="col-md-6">
                    <label for="date">Birth</label>
                    <input style="font-size: medium" type="date" name="birth" class="form-control"
                        id="date" name="date" value="{{ $user->customer->birth }}">
                </div>
